            ...
            <div className='border-b-2 border-slate-800 bg-black h-20 w-full px-2'>
                <div className='h-full flex justify-between items-center'>
                    <div className='flex gap-2 items-center'>
                        ...
                        <FaArrowLeft className='text-xl sm:hidden' onClick={() => setSelectedConversation(null)} /> 
                        <div>
                            <div className="avatar avatar-placeholder">
                                <div className="bg-neutral border border-white text-neutral-content w-10 rounded-full">
                                    <span className="text-xl capitalize font-bold">{selectedConversation?.username.charAt(0)}</span>
                                </div>
                            </div>
                        </div>
                        <div>
